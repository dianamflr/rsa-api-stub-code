...
class LongleyRicePropModelParameters(Model):
    ...
    def service_threshold(self, service_threshold: float):
        ...
        if service_threshold is None:
            raise ValueError("Invalid value for `service_threshold`, must not be `None`")  # noqa: E501
    ...
    def surface_refractivity(self, surface_refractivity: float):
        ...
        :type surface_refractivity: float
        """
        if surface_refractivity is None:
            raise ValueError("Invalid value for `surface_refractivity`, must not be `None`")  # noqa: E501
    ...
    def ground_dielectric_const(self, ground_dielectric_const: float):
        ...
        :type ground_dielectric_const: float
        """
        if ground_dielectric_const is None:
            raise ValueError("Invalid value for `ground_dielectric_const`, must not be `None`")  # noqa: E501
    ...
    def ground_conductivity(self, ground_conductivity: float):
        ...
        :type ground_conductivity: float
        """
        if ground_conductivity is None:
            raise ValueError("Invalid value for `ground_conductivity`, must not be `None`")  # noqa: E501
    ...
    def climatic_zone(self, climatic_zone: str):
        ...
        :type climatic_zone: str
        """
        if climatic_zone is None:
            raise ValueError("Invalid value for `climatic_zone`, must not be `None`")  # noqa: E501
    ...
    def time_avail(self, time_avail: float):
        ...
        if time_avail is None:
            raise ValueError("Invalid value for `time_avail`, must not be `None`")  # noqa: E501
    ...
    def rx_height(self, rx_height: float):
        ...
        if rx_height is None:
            raise ValueError("Invalid value for `rx_height`, must not be `None`")  # noqa: E501
    ...
    def elev_data_sampling_res_km(self, elev_data_sampling_res_km: float):
        ...
        :type elev_data_sampling_res_km: float
        """
        if elev_data_sampling_res_km is None:
            raise ValueError("Invalid value for `elev_data_sampling_res_km`, must not be `None`")  # noqa: E501
    ...
    def elev_source(self, elev_source: str):
        ...
        if elev_source is None:
            raise ValueError("Invalid value for `elev_source`, must not be `None`")  # noqa: E501
