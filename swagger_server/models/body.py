...
class Body(Model):
    ...
    """
    def __init__(self, name: str=None, services: List[BodyServices]=None, operators: List[str]=None, service_areas: List[str]=None, aggregation_level: str=None, propagation_model: BodyPropagationModel=None, dataset_date: date=None, result_url: str=None):  # noqa: E501
        ...
        :param service_areas: The service_areas of this Body.  # noqa: E501
    ...
    def service_areas(self) -> List[str]:
        """Gets the service_areas of this Body.


        :return: The service_areas of this Body.
        :rtype: List[str]
        """
    ...
    def service_areas(self, service_areas: List[str]):
        """Sets the service_areas of this Body.


        :param service_areas: The service_areas of this Body.
        :type service_areas: List[str]
        """
        if service_areas is None:
            raise ValueError("Invalid value for `service_areas`, must not be `None`")  # noqa: E501
